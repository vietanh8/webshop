...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="{{url('adminpanel')}}">FOOTWEAR</a>
			</div>
				...
				<form class="navbar-form navbar-left">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							...
							@endif
							<ul class="dropdown-menu">
								<li><a href="{{route('admininfo')}}"><i class="lnr lnr-user"></i> <span>My Profile</span></a></li>
								<li><a href="#"><i class="lnr lnr-envelope"></i> <span>Message</span></a></li>
								<li><a href="#"><i class="lnr lnr-cog"></i> <span>Settings</span></a></li>
								<li><a href="{{route('adminlogout')}}"><i class="lnr lnr-exit"></i> <span>Logout</span></a></li>
							</ul>
						</li>
					</ul>
				</div>
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="{{'adminpanel'}}" class="active"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
						<li>
							<a href="#subPages" data-toggle="collapse" class="collapsed"><i class="lnr lnr-list"></i> <span>Products</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="{{route('listproduct')}}" class="">List Products</a></li>
									<li><a href="{{route('addproduct')}}" class="">Add Product</a></li>
								</ul>
							</div>
						</li>
						<li><a href="{{route('member')}}" ><i class="fa fa-user-secret"></i> <span>Member</span></a></li>
						<li>
