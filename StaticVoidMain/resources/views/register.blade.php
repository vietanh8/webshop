								...
								<div class="row">
									...
									<div class="col-sm-12">
										<div class="form-group">
											...
											<input type="text" namme="address" class="form-control" placeholder="Your address">
										</div>
									</div>
									<div class="col-sm-12">
										<div class="form-group">
											<label for="subject">Phone</label>
											<input type="number" namme="phone" class="form-control" placeholder="Your phone">
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input type="password" namme="repassword" class="form-control" placeholder="Confirm your password">
										</div>
									</div>
									<div class="w-100"></div>
									<div class="w-100"></div>
